...
<details>
  ...
  * Drivable Cars:
    * Space Cadet has cars archived [here](https://simfileshare.net/folder/264610/) and a video demoing their functionality can be seen [here](https://www.youtube.com/watch?v=t_Rih-BuGEQ). Go to vehicles 1 and 2 in the link to download them.
  * [Zappers](https://simlogical.com/sl/downloadpages/zappers.htm) Gets rid of unwanted NPCs on lots, such as the Unleashed musicians, mailwoman, etc. 
